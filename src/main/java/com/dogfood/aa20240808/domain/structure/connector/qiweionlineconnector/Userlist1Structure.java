...
public class Userlist1Structure {
    ...
    public String name;
    public String alias;
    public com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.ExtattrStructure extattr;
    public String qr_code;
    public String position;
    public List<Long> department = new ArrayList<>();
    public String open_userid;
    public String biz_mail;
    public com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.External_profileStructure external_profile;
    public String email;
    ...
    public com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.ExtattrStructure getExtattr() {
        return extattr;
    } 

    public void setExtattr(com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.ExtattrStructure extattr) {
    ...
    public com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.External_profileStructure getExternal_profile() {
        return external_profile;
    } 

    public void setExternal_profile(com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.External_profileStructure external_profile) {
