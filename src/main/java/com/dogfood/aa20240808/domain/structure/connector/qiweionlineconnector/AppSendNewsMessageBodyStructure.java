...
public class AppSendNewsMessageBodyStructure {
    ...
    public Long agentid;
    public com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.News1Structure news;
    ...
    public com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.News1Structure getNews() {
        return news;
    } 

    public void setNews(com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.News1Structure news) {
        this.news = news; 
    } 
