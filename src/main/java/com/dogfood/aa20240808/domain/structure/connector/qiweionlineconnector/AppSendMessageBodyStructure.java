...
public class AppSendMessageBodyStructure {
    ...
    public Long agentid;
    public com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.Text7Structure text;
    public Long safe;
    ...
    public com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.Text7Structure getText() {
        return text;
    } 

    public void setText(com.dogfood.aa20240808.domain.structure.connector.qiweionlineconnector.Text7Structure text) {
        this.text = text; 
    } 
