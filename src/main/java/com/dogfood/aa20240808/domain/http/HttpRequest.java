package com.dogfood.aa20240808.domain.http;
...
public class HttpRequest<T> {
    ...
    */
    ...
    public HttpRequest<T> addHeader(String key, Object value) {
        if (null == value) {
            return this;
        }
    ...
    public <V> HttpRequest<T> addQueryParam(final String name, final Object value) {
        if (value == null){
            return this;
        }
