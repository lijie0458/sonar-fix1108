...
import com.dogfood.aa20240808.util.SqlKeywordsUtils;
import com.dogfood.aa20240808.web.interceptor.annotation.SqlInjectionCheck;
...
public class SqlInjectionCheckAspect {
    ...
    @Pointcut(value = "@annotation(com.dogfood.aa20240808.web.interceptor.annotation.SqlInjectionCheck)")
