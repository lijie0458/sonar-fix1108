...
/**
* auto generate LCAPUserDeptMapping controller
*
* @author sys
*/
@RestController
public class LCAPUserDeptMappingController {
    @Resource
    private LCAPUserDeptMappingService service;
    ...
    **/
    @PostMapping("/api/l-c-a-p-user-dept-mapping/import")
