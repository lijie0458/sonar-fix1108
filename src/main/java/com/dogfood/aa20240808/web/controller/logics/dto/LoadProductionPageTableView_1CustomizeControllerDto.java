...
public class LoadProductionPageTableView_1CustomizeControllerDto {

    public DistinctionEnumEnum DistinctionEnum;
    public ProductionMaterialRequisitionEntity filter;
    ...
    public ProductionMaterialRequisitionEntity getFilter() {
        return filter;
    } 

    public void setFilter(ProductionMaterialRequisitionEntity filter) {
        this.filter = filter; 
    } 
