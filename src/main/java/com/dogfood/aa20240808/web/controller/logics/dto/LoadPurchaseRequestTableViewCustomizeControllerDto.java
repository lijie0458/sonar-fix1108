...
public class LoadPurchaseRequestTableViewCustomizeControllerDto {

    public PurchaseRequestEntity filter;
    ...
    public Long page;
    public String order;
    public PurchaseRequestEntity getFilter() {
        return filter;
    } 

    public void setFilter(PurchaseRequestEntity filter) {
        this.filter = filter; 
    } 
