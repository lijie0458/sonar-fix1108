...
public class LoadBePutInStorageListTableView_2CustomizeControllerDto {

    public BePutInStorageEntity filter;
    ...
    public Long page;
    public String order;
    public BePutInStorageEntity getFilter() {
        return filter;
    } 

    public void setFilter(BePutInStorageEntity filter) {
        this.filter = filter; 
    } 
