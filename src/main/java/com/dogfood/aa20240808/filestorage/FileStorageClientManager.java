...
import com.dogfood.aa20240808.config.ExtensionProperties;
import com.dogfood.aa20240808.config.LcpProperties;
import com.dogfood.aa20240808.filestorage.spi.ExtensionFileStorageClient;
...
import static com.dogfood.aa20240808.filestorage.FileStorageClient.UPLOAD_CONFIG_KEY_S3_ACCESS;
...
public class FileStorageClientManager {
    ...
    private void loadBuiltInFileSystemSpi() {
        ...
        builtInConfigs.put(UPLOAD_CONFIG_KEY_S3_ACCESS, lcpProperties.getUpload().getAccess());
