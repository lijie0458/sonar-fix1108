...
public class AddProcessRecordCmd implements Command<Comment> {
    ...
    public AddProcessRecordCmd(String processInstanceId, String taskId, String userName, Date recordCreateTime,
