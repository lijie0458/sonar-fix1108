...
public class LCAPUserRoleMappingService extends AbstractService {
    ...
    @Resource
    private LCAPUserRoleMappingService entityService;
    ...
    **/
    ...
    public void beforeUpdate(LCAPUserRoleMapping entity) {
        if (null == entity) {
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPUserRoleMapping", "lcap_user_role_mapping_a6d592", "id", "id"))
