...
import java.time.ZonedDateTime;
/**
* auto generate ProductReturnStorageDetailsEntityService ServiceImpl
*
* @author sys
*/
@Service
public class ProductReturnStorageDetailsEntityService extends AbstractService {
    @Resource
    private ProductReturnStorageDetailsEntityMapper mapper;
    @Resource
    private RelationInnerService relationInnerService;
    @Resource
    private ProductReturnStorageDetailsEntityService entityService;
    ...
    public ProductReturnStorageDetailsEntityService() {
        ...
        entityFieldTitleNameMap.put("产品入库详情id", "productInStorageDetailsId");
        entityFiledColumnNameMap.put("productInStorageDetailsId", "product_in_storage_details_id");
        entityFieldTitleNameMap.put("退回数量", "quantity");
        entityFiledColumnNameMap.put("quantity", "quantity");
        entityFieldTitleNameMap.put("退回单号", "productReturnStorageCode");
        entityFiledColumnNameMap.put("productReturnStorageCode", "product_return_storage_code");
    ...
    **/
    public List<ProductReturnStorageDetailsEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<ProductReturnStorageDetailsEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, ProductReturnStorageDetailsEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + ProductReturnStorageDetailsEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
         ...
         * auto gen get method
         **/
        public ProductReturnStorageDetailsEntity get( Long id ) { 
            if ( id == null ) { 
                throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
            }

            ProductReturnStorageDetailsEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public ProductReturnStorageDetailsEntity create(ProductReturnStorageDetailsEntity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<ProductReturnStorageDetailsEntity> batchCreate(List<ProductReturnStorageDetailsEntity> entities) {
        ...
        // fill default value
        List<ProductReturnStorageDetailsEntity> batchList = new ArrayList<>(100);
        for (ProductReturnStorageDetailsEntity entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
            entity.setUpdatedBy(StringUtils.isBlank(entity.getUpdatedBy()) ? currentUserName : entity.getUpdatedBy());
            paramValidate(entity);
    ...
    public void beforeUpdate(ProductReturnStorageDetailsEntity entity) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "ProductReturnStorageDetailsEntity");
        }
    ...
    **/
    @Transactional
    public ProductReturnStorageDetailsEntity update(ProductReturnStorageDetailsEntity entity, List<String> updateFields) {
        beforeUpdate(entity);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<ProductReturnStorageDetailsEntity> batchUpdate(List<ProductReturnStorageDetailsEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("ProductReturnStorageDetails", "product_return_storage_details", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<ProductReturnStorageDetailsEntity>  entities = mapper.selectList(inQueryFilter);
        for (ProductReturnStorageDetailsEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<ProductReturnStorageDetailsEntity> data = ExcelUtil.read(file.getInputStream(), type, ProductReturnStorageDetailsEntity.class, entityFieldTitleNameMap);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public ProductReturnStorageDetailsEntity createOrUpdate(ProductReturnStorageDetailsEntity entity, List<String> updateFields) {
        if (null == entity) {
        ...
        if ( entity.getId() == null ) { 
            ...
            ProductReturnStorageDetailsEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                UserContext.UserInfo currentUserInfo = UserContext.getCurrentUserInfo();
                String currentUserName = null == currentUserInfo ? null : currentUserInfo.getUserName();
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(ProductReturnStorageDetailsEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
