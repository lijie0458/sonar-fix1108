...
import java.time.ZonedDateTime;
/**
* auto generate PerGroupPerMappingEntityService ServiceImpl
*
* @author sys
*/
@Service
public class PerGroupPerMappingEntityService extends AbstractService {
    @Resource
    private PerGroupPerMappingEntityMapper mapper;
    @Resource
    private RelationInnerService relationInnerService;
    @Resource
    private PerGroupPerMappingEntityService entityService;
    ...
    public PerGroupPerMappingEntityService() {
        ...
        entityFieldTitleNameMap.put("权限组id", "perGroupId");
        entityFiledColumnNameMap.put("perGroupId", "per_group_id");
        entityFieldTitleNameMap.put("权限id", "perId");
        entityFiledColumnNameMap.put("perId", "per_id");
    ...
    **/
    public List<PerGroupPerMappingEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<PerGroupPerMappingEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, PerGroupPerMappingEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + PerGroupPerMappingEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
         ...
         * auto gen get method
         **/
        public PerGroupPerMappingEntity get( Long id ) { 
            if ( id == null ) { 
                throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
            }

            PerGroupPerMappingEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public PerGroupPerMappingEntity create(PerGroupPerMappingEntity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<PerGroupPerMappingEntity> batchCreate(List<PerGroupPerMappingEntity> entities) {
        ...
        // fill default value
        List<PerGroupPerMappingEntity> batchList = new ArrayList<>(100);
        for (PerGroupPerMappingEntity entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
            entity.setUpdatedBy(StringUtils.isBlank(entity.getUpdatedBy()) ? currentUserName : entity.getUpdatedBy());
            paramValidate(entity);
    ...
    public void beforeUpdate(PerGroupPerMappingEntity entity) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "PerGroupPerMappingEntity");
        }
    ...
    **/
    @Transactional
    public PerGroupPerMappingEntity update(PerGroupPerMappingEntity entity, List<String> updateFields) {
        beforeUpdate(entity);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<PerGroupPerMappingEntity> batchUpdate(List<PerGroupPerMappingEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("PerGroupPerMapping", "per_group_per_mapping", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<PerGroupPerMappingEntity>  entities = mapper.selectList(inQueryFilter);
        for (PerGroupPerMappingEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<PerGroupPerMappingEntity> data = ExcelUtil.read(file.getInputStream(), type, PerGroupPerMappingEntity.class, entityFieldTitleNameMap);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public PerGroupPerMappingEntity createOrUpdate(PerGroupPerMappingEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, PerGroupPerMappingEntity.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            PerGroupPerMappingEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                UserContext.UserInfo currentUserInfo = UserContext.getCurrentUserInfo();
                String currentUserName = null == currentUserInfo ? null : currentUserInfo.getUserName();
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(PerGroupPerMappingEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
