...
import java.time.ZonedDateTime;
/**
* auto generate OtherReturnStorageDetailsEntityService ServiceImpl
*
* @author sys
*/
@Service
public class OtherReturnStorageDetailsEntityService extends AbstractService {
    @Resource
    private OtherReturnStorageDetailsEntityMapper mapper;
    @Resource
    private RelationInnerService relationInnerService;
    @Resource
    private OtherReturnStorageDetailsEntityService entityService;
    ...
    public OtherReturnStorageDetailsEntityService() {
        ...
        entityFieldTitleNameMap.put("其他入库详情id", "otherInSDetailsId");
        entityFiledColumnNameMap.put("otherInSDetailsId", "other_in_s_details_id");
        entityFieldTitleNameMap.put("退回数量", "quantity");
        entityFiledColumnNameMap.put("quantity", "quantity");
        entityFieldTitleNameMap.put("其他入库退回单号", "otherReturnSCode");
        entityFiledColumnNameMap.put("otherReturnSCode", "other_return_s_code");
    ...
    **/
    public List<OtherReturnStorageDetailsEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<OtherReturnStorageDetailsEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, OtherReturnStorageDetailsEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + OtherReturnStorageDetailsEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
         ...
         * auto gen get method
         **/
        public OtherReturnStorageDetailsEntity get( Long id ) { 
            if ( id == null ) { 
                throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
            }

            OtherReturnStorageDetailsEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public OtherReturnStorageDetailsEntity create(OtherReturnStorageDetailsEntity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<OtherReturnStorageDetailsEntity> batchCreate(List<OtherReturnStorageDetailsEntity> entities) {
        ...
        // fill default value
        List<OtherReturnStorageDetailsEntity> batchList = new ArrayList<>(100);
        for (OtherReturnStorageDetailsEntity entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
            entity.setUpdatedBy(StringUtils.isBlank(entity.getUpdatedBy()) ? currentUserName : entity.getUpdatedBy());
            paramValidate(entity);
    ...
    public void beforeUpdate(OtherReturnStorageDetailsEntity entity) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "OtherReturnStorageDetailsEntity");
        }
    ...
    **/
    @Transactional
    public OtherReturnStorageDetailsEntity update(OtherReturnStorageDetailsEntity entity, List<String> updateFields) {
        beforeUpdate(entity);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<OtherReturnStorageDetailsEntity> batchUpdate(List<OtherReturnStorageDetailsEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("OtherReturnStorageDetails", "other_return_storage_details", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<OtherReturnStorageDetailsEntity>  entities = mapper.selectList(inQueryFilter);
        for (OtherReturnStorageDetailsEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<OtherReturnStorageDetailsEntity> data = ExcelUtil.read(file.getInputStream(), type, OtherReturnStorageDetailsEntity.class, entityFieldTitleNameMap);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public OtherReturnStorageDetailsEntity createOrUpdate(OtherReturnStorageDetailsEntity entity, List<String> updateFields) {
        if (null == entity) {
        ...
        if ( entity.getId() == null ) { 
            ...
            OtherReturnStorageDetailsEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                UserContext.UserInfo currentUserInfo = UserContext.getCurrentUserInfo();
                String currentUserName = null == currentUserInfo ? null : currentUserInfo.getUserName();
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(OtherReturnStorageDetailsEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
