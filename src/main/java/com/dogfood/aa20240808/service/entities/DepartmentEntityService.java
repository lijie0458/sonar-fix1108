...
import com.dogfood.aa20240808.repository.entities.DepartmentEntityMapper;
...
import java.time.ZonedDateTime;
/**
* auto generate DepartmentEntityService ServiceImpl
*
* @author sys
*/
@Service
public class DepartmentEntityService extends AbstractService {
    @Resource
    ...
    public DepartmentEntityService() {
        ...
        entityFieldTitleNameMap.put("部门名称", "department_Name");
        entityFiledColumnNameMap.put("department_Name", "department__name");
        entityFieldTitleNameMap.put("上级部门id", "parent_id");
        entityFiledColumnNameMap.put("parent_id", "parent_id");
    ...
    **/
    public List<DepartmentEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<DepartmentEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, DepartmentEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + DepartmentEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
        ...
        public DepartmentEntity get( Long id ) { 
            ...
            DepartmentEntity entity = mapper.selectOne( id ); 
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<DepartmentEntity> batchCreate(List<DepartmentEntity> entities) {
        ...
        // fill default value
        List<DepartmentEntity> batchList = new ArrayList<>(100);
    ...
    public void beforeUpdate(DepartmentEntity entity) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "DepartmentEntity");
        }
    ...
    **/
    @Transactional
    public DepartmentEntity update(DepartmentEntity entity, List<String> updateFields) {
        beforeUpdate(entity);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<DepartmentEntity> batchUpdate(List<DepartmentEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<DepartmentEntity> data = ExcelUtil.read(file.getInputStream(), type, DepartmentEntity.class, entityFieldTitleNameMap);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public DepartmentEntity createOrUpdate(DepartmentEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, DepartmentEntity.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            DepartmentEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                UserContext.UserInfo currentUserInfo = UserContext.getCurrentUserInfo();
                String currentUserName = null == currentUserInfo ? null : currentUserInfo.getUserName();
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(DepartmentEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
