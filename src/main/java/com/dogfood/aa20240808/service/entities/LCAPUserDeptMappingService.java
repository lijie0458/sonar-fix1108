...
public class LCAPUserDeptMappingService extends AbstractService {
    ...
    @Resource
    private LCAPUserDeptMappingService entityService;
    ...
    **/
    ...
    public void beforeUpdate(LCAPUserDeptMapping entity) {
        if (null == entity) {
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPUserDeptMapping", "lcap_user_dept_mapping_a6d592", "id", "id"))
