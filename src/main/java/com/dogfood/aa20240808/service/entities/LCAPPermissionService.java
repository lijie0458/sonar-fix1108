...
import com.dogfood.aa20240808.repository.entities.LCAPPermissionMapper;
...
import java.time.ZonedDateTime;
/**
* auto generate LCAPPermissionService ServiceImpl
*
* @author sys
*/
@Service
public class LCAPPermissionService extends AbstractService {
    ...
    @Resource
    private LCAPPermissionService entityService;
    ...
    **/
    ...
    public List<LCAPPermission> batchCreate(List<LCAPPermission> entities) {
        ...
        // fill default value
        List<LCAPPermission> batchList = new ArrayList<>(100);
    ...
    public void beforeUpdate(LCAPPermission entity) {
        if (null == entity) {
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPPermission", "lcap_permission_a6d592", "id", "id"))
