...
import java.time.ZonedDateTime;
/**
* auto generate ThirdIdentityEntityService ServiceImpl
*
* @author sys
*/
@Service
public class ThirdIdentityEntityService extends AbstractService {
    @Resource
    private ThirdIdentityEntityMapper mapper;
    @Resource
    private RelationInnerService relationInnerService;
    @Resource
    private ThirdIdentityEntityService entityService;
    ...
    public ThirdIdentityEntityService() {
        ...
        entityFieldTitleNameMap.put("用户三方唯一id", "openId");
        entityFiledColumnNameMap.put("openId", "open_id");
        entityFieldTitleNameMap.put("身份源表id", "identityId");
        entityFiledColumnNameMap.put("identityId", "identity_id");
        entityFieldTitleNameMap.put("昵称", "name");
    ...
    **/
    public List<ThirdIdentityEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<ThirdIdentityEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, ThirdIdentityEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + ThirdIdentityEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
         ...
         * auto gen get method
         **/
        public ThirdIdentityEntity get( Long id ) { 
            if ( id == null ) { 
                throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
            }

            ThirdIdentityEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public ThirdIdentityEntity create(ThirdIdentityEntity entity) {
        if (null == entity) {
        ...
        entity.setOpenId(getOrDefault(entity.getOpenId(), ""));
        entity.setIdentityId(getOrDefault(entity.getIdentityId(), 0L));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<ThirdIdentityEntity> batchCreate(List<ThirdIdentityEntity> entities) {
        ...
        // fill default value
        List<ThirdIdentityEntity> batchList = new ArrayList<>(100);
        for (ThirdIdentityEntity entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
            entity.setUpdatedBy(StringUtils.isBlank(entity.getUpdatedBy()) ? currentUserName : entity.getUpdatedBy());
            entity.setOpenId(getOrDefault(entity.getOpenId(), ""));
    ...
    public void beforeUpdate(ThirdIdentityEntity entity) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "ThirdIdentityEntity");
        }
    ...
    **/
    @Transactional
    public ThirdIdentityEntity update(ThirdIdentityEntity entity, List<String> updateFields) {
        beforeUpdate(entity);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<ThirdIdentityEntity> batchUpdate(List<ThirdIdentityEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("ThirdIdentity", "ThirdIdentity", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<ThirdIdentityEntity>  entities = mapper.selectList(inQueryFilter);
        for (ThirdIdentityEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<ThirdIdentityEntity> data = ExcelUtil.read(file.getInputStream(), type, ThirdIdentityEntity.class, entityFieldTitleNameMap);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public ThirdIdentityEntity createOrUpdate(ThirdIdentityEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, ThirdIdentityEntity.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            ThirdIdentityEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                UserContext.UserInfo currentUserInfo = UserContext.getCurrentUserInfo();
                String currentUserName = null == currentUserInfo ? null : currentUserInfo.getUserName();
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(ThirdIdentityEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
