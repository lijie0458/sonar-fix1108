...
public class PurchaseRequestEntityService extends AbstractService {
    ...
    @Resource
    private PurchaseRequestEntityService entityService;
    ...
    **/
    ...
    public void beforeUpdate(PurchaseRequestEntity entity) {
        if (null == entity) {
    ...
    **/
    ...
    public List<PurchaseRequestEntity> batchUpdate(List<PurchaseRequestEntity> entities, List<String> updateFields) {
        ...
        if (updateFields != null && updateFields.size() == 1 && updateFields.contains("requestNumber")) {
