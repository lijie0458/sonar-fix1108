...
import java.time.ZonedDateTime;
/**
* auto generate OutsourceReturnStorageDetailsEntityService ServiceImpl
*
* @author sys
*/
@Service
public class OutsourceReturnStorageDetailsEntityService extends AbstractService {
    @Resource
    private OutsourceReturnStorageDetailsEntityMapper mapper;
    @Resource
    private RelationInnerService relationInnerService;
    @Resource
    private OutsourceReturnStorageDetailsEntityService entityService;
    ...
    public OutsourceReturnStorageDetailsEntityService() {
        ...
        entityFieldTitleNameMap.put("委外加工入库详情id", "outsourceInSDetailsId");
        entityFiledColumnNameMap.put("outsourceInSDetailsId", "outsource_in_s_details_id");
        entityFieldTitleNameMap.put("退回数量", "quantity");
        entityFiledColumnNameMap.put("quantity", "quantity");
        entityFieldTitleNameMap.put("委外加工入库退回单号", "outsourceReturnSCode");
        entityFiledColumnNameMap.put("outsourceReturnSCode", "outsource_return_s_code");
    ...
    **/
    public List<OutsourceReturnStorageDetailsEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<OutsourceReturnStorageDetailsEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, OutsourceReturnStorageDetailsEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + OutsourceReturnStorageDetailsEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
         ...
         * auto gen get method
         **/
        public OutsourceReturnStorageDetailsEntity get( Long id ) { 
            if ( id == null ) { 
                throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
            }

            OutsourceReturnStorageDetailsEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public OutsourceReturnStorageDetailsEntity create(OutsourceReturnStorageDetailsEntity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<OutsourceReturnStorageDetailsEntity> batchCreate(List<OutsourceReturnStorageDetailsEntity> entities) {
        ...
        // fill default value
        List<OutsourceReturnStorageDetailsEntity> batchList = new ArrayList<>(100);
        for (OutsourceReturnStorageDetailsEntity entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
            entity.setUpdatedBy(StringUtils.isBlank(entity.getUpdatedBy()) ? currentUserName : entity.getUpdatedBy());
            paramValidate(entity);
    ...
    public void beforeUpdate(OutsourceReturnStorageDetailsEntity entity) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "OutsourceReturnStorageDetailsEntity");
        }
    ...
    **/
    @Transactional
    public OutsourceReturnStorageDetailsEntity update(OutsourceReturnStorageDetailsEntity entity, List<String> updateFields) {
        beforeUpdate(entity);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<OutsourceReturnStorageDetailsEntity> batchUpdate(List<OutsourceReturnStorageDetailsEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("OutsourceReturnStorageDetails", "outsource_return_storage_details", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<OutsourceReturnStorageDetailsEntity>  entities = mapper.selectList(inQueryFilter);
        for (OutsourceReturnStorageDetailsEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<OutsourceReturnStorageDetailsEntity> data = ExcelUtil.read(file.getInputStream(), type, OutsourceReturnStorageDetailsEntity.class, entityFieldTitleNameMap);
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public OutsourceReturnStorageDetailsEntity createOrUpdate(OutsourceReturnStorageDetailsEntity entity, List<String> updateFields) {
        if (null == entity) {
        ...
        if ( entity.getId() == null ) { 
            ...
            OutsourceReturnStorageDetailsEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                UserContext.UserInfo currentUserInfo = UserContext.getCurrentUserInfo();
                String currentUserName = null == currentUserInfo ? null : currentUserInfo.getUserName();
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(OutsourceReturnStorageDetailsEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
