...
public class DynamicDataSourceAspect {
    ...
    @Pointcut("@annotation(com.dogfood.aa20240808.datasource.dynamic.DataSource) || " +
            "within(@com.dogfood.aa20240808.datasource.dynamic.DataSource *)")
    ...
    public Object arround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        String prevDataSource = DynamicDataSource.getCurrentDataSource();
        if (null != dataSource) {
        ...
        try {
            ...
            DynamicDataSource.setCurrentDataSource(prevDataSource);
        }
    }
}
